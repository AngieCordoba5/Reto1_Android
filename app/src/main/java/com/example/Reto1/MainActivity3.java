...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Imagen 1 Llamadas
        Drawable drawable1 = res.getDrawable(R.drawable.telefono, getTheme());
        ImageView imagen1 = (ImageView) findViewById(R.id.imagen1);
        imagen1.setImageDrawable(drawable1);

        //Imagen 2 Whatsapp
        Drawable drawable2 = res.getDrawable(R.drawable.wa, getTheme());
        ImageView imagen2 = (ImageView) findViewById(R.id.imagen2);
        imagen2.setImageDrawable(drawable2);

        //Imagen 3 Domicilios
        Drawable drawable3 = res.getDrawable(R.drawable.domicilio, getTheme());
